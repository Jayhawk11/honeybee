          ...
          - generic [ref=e26]:
            ...
            - generic [ref=e52]:
              - paragraph [ref=e53]:
                - text: Call Stack
                - generic [ref=e54]: "64"
              - button "Show 64 ignore-listed frame(s)" [ref=e55] [cursor=pointer]:
                - text: Show 64 ignore-listed frame(s)
                - img [ref=e56]
          - generic [ref=e58]: "1"
          - generic [ref=e59]: "2"
        - contentinfo [ref=e60]:
    ...
    - generic [ref=e75] [cursor=pointer]:
      ...
      - generic [ref=e81]:
        ...
        - button "Collapse issues badge" [ref=e88]:
          - img [ref=e89]
  - 'heading "Application error: a client-side exception has occurred while loading localhost (see the browser console for more information)." [level=2] [ref=e93]'
```